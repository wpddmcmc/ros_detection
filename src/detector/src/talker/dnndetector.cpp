...
DnnDetector::DnnDetector()
{
    ...
    cv::FileStorage setting_fs(ros::package::getPath("detector") + "/param/dnn_param.xml", cv::FileStorage::READ);
...
/****************************************************************************** 
    ...
    ****************************************************************************/
std::vector<std::string> DnnDetector::getOutputsNames(cv::dnn::Net &net)
{
